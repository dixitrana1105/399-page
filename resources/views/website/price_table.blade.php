...
{{-- {{ dd($data[2]); }} --}}
    <h3 _ngcontent-mro-c11="" class="dv_hair_packages_heading">{{ $data[2]->text_details[0]->header }} </h3>
                    ...
                    <div _ngcontent-mro-c11="" class="swiper-slide"><a _ngcontent-mro-c11=""
                            ...
                            <div _ngcontent-mro-c11="" class="display-none-sm">
                                <img _ngcontent-mro-c11=""
                                    ...
                                    class="dv_price_table_animated_img">
                            </div>
                ...
                <div data-swiper-slide-index="3" class="dv_per_staff_col swiper-slide"
                    ...
                    <div _ngcontent-mro-c11="" class="swiper-slide"><a _ngcontent-mro-c11=""
                        ...
                        <div _ngcontent-mro-c11="" class="display-block-sm"><img _ngcontent-mro-c11=""
                                src="{{ $link_project->site_value . $data[2]->button_details->{3}->image_path }}"
                                class="w-100"><img _ngcontent-mro-c11=""
                                src="{{ $link_project->site_value . $data[2]->button_details->{4}->image_path }}"
                                class="dv_price_table_animated_img"></div>
                    </a></div>
            </div>
